...
func newSession(sm SessionManager, remoteNodeId string, active bool, conn net.Conn, logger log.Logger) *session {
	s := &session{
...
func newSessionPacketReadWriter(sm SessionManager) *sessionPacketReadWriter {
