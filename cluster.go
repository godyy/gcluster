...
func CreateClient(
	...
	if handler == nil {
		return nil, pkgerrors.New("gcluster: handler nil")
	}
	...
	sessionMgr, err := net.CreateClient(cfg, dialer, agent, logger, optSet.smOptions...)
	if err != nil {
		return nil, err
	}
...
func CreateService(
	...
	sessionMgr, err := net.CreateService(cfg, dialer, createListener, agent, logger, optSet.smOptions...)
	if err != nil {
		return nil, err
	}
